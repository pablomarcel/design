...
class WeldingBondingCLI:
    ...
    def _build_parser(self) -> argparse.ArgumentParser:
        ...
        torsion.add_argument('--primary-shear-direction', default='negative_x', choices=['positive_x', 'negative_x', 'positive_y', 'negative_y'])
        torsion.add_argument('--torsion-sign', default='ccw', choices=['ccw', 'cw'])
        torsion.add_argument('--combination-model', default='shigley_radial', choices=['shigley_radial', 'tangential'])
